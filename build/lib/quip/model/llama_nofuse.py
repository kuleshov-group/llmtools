...
#
# This is a slightly modified verrsion of the HuggingFace Llama implementation
#
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    # def config_ifno_quip(config):
    #     if 'quip_params' not in config:
    #         config['quip_params'] = {
    #             'lora_rank' : -1,
    #             'scaleWH' : False 
    #         }
    #         print("config_ifno_quip(): modifying llama config to add None values for quip_params")
    #     else:
    #         print("config_ifno_quip(): quip_params in config")
    #     print(config)

    # def add_quip_params(self, lora_rank, rescale_WH):
    #     for layer in self.layers:
    #         layer.config['quip_params'] = {
    #             'lora_rank' : lora_rank,
