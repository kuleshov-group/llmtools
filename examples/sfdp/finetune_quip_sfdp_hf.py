...
from sfdp_utils import create_and_prepare_model, create_datasets
...
class ModelArguments:
    ...
    use_quip_quantization: Optional[bool] = field(
        default=False,
        metadata={"help": "Enables loading model in 2bit QUIP#."},
    )
