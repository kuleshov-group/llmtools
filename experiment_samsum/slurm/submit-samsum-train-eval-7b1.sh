...
cd /share/kuleshov/jy928/llmtools-2bit-e8/experiment_samsum && conda run -p /share/kuleshov/jy928/envs/llmtools-quip-0 --no-capture-output python samsum_quip/train_samsum_llama_quip.py --model_name relaxml/Llama-1-7b-E8P-2Bit --adapter llama1_adapters/llama1-samsum-e8-7b-fix-seed42-mb4 --seed 42 --mbatch_size 4
