...
## 
class QuantLinearQuip(nn.Module):
    ...
    def forward(self, input):
        ...
        ## Wrap codebook_class into Autograd Class that support PyTorch Autograd.
        ## TODO
        out = Autograd4bit.apply(
                x, 
                self.qweight, 
        ...
        ## return the returns of QuantizedD4Linear() foward()
